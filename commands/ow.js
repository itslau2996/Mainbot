...
module.exports = {
    name:   'ow',
    description: "this is a topic cmd",
    execute(message, args){
        ...
        , "#9 Hoe vaak ben je nog na 01.00 uur wakker?", "Wat beschouw je als de grofste gewoonte die sommige mensen hebben?", "Ben je georganiseerd in je privéleven of aardig rommelig?",
        ...
        "#16 Wat is je “guilty pleasure” als je moet ontspannen?",  "#17 Wie is de persoon in je leven die je het gelukkigst maakt?", "#18 Als je gestrest bent, wat doe je dan om te ontspannen?",  
